# booleansearchfilter cookbook for PmWiki
...
user:
    ...
    docker exec -it pmwiki-booleansearchfilter-ctr bash
...
`www-data` user:
    ...
    docker exec -it -u www-data pmwiki-booleansearchfilter-ctr bash
